...
{
    /// <summary>
    /// <para>Defines a specific property that is able to get or set values of that property.</para>
    /// <para>Определяет определённого свойства, который может получать или установливать его значения.</para>
    /// </summary>
